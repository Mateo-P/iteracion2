...
/*RF8*/
SELECT * FROM RESERVA WHERE FECHA_INICIO_RESERVA= DATE'2015-12-17'
AND fecha_final_reserva= DATE'2016-1-17' AND fecha_generacion_reserva=DATE'2019-12-17' AND id_cliente=1007863890;
