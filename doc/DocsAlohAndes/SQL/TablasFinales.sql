...
INTO INMUEBLE (ID_INMUEBLE, DISPONIBLE,NOMBRE,TIPO_INMUEBLE,UBICACION,CAPACIDAD,DESCRIPCION,VECES_RESERVADA,COSTO_NOCHE,ID_OPERADOR)
VALUES (2, 'Y','HABITACION_HILTON','HABITACION_HOTEL','CRA 40 #25C-12',5,'4 CAMAS Y DOS BA�OS',5,100,'1007863891')

INTO INMUEBLE (ID_INMUEBLE, DISPONIBLE,NOMBRE,TIPO_INMUEBLE,UBICACION,CAPACIDAD,DESCRIPCION,VECES_RESERVADA,COSTO_NOCHE,ID_OPERADOR)
VALUES (3, 'Y','HABITACION DE PABLO','HABITACION_PERSONA_NATURAL','CRA 20 #29C-76',1,'1 BA�O Y UNA CAMA',3,50,'1007863892')

INTO INMUEBLE (ID_INMUEBLE, DISPONIBLE,NOMBRE,TIPO_INMUEBLE,UBICACION,CAPACIDAD,DESCRIPCION,VECES_RESERVADA,COSTO_NOCHE,ID_OPERADOR)
VALUES (4, 'Y','HABITACION BUEN VIVIR','HABITACION_HOSTEL','CRA 70 60C-76',3,'3 CAMAS 2 BA�OS',7,80,'1007863893')

INTO INMUEBLE (ID_INMUEBLE, DISPONIBLE,NOMBRE,TIPO_INMUEBLE,UBICACION,CAPACIDAD,DESCRIPCION,VECES_RESERVADA,COSTO_NOCHE,ID_OPERADOR)
VALUES (5, 'Y','HABITACION ALOHA','HABITACION_UNIVERSITARIA','CRA 10 #19C-76',1,'1 CAMA 1 BA�O',4,150,'1007863894')
...
INTO INMUEBLE (ID_INMUEBLE, DISPONIBLE,NOMBRE,TIPO_INMUEBLE,UBICACION,CAPACIDAD,DESCRIPCION,VECES_RESERVADA,COSTO_NOCHE,ID_OPERADOR)
VALUES (8, 'Y','HABITACION_HOLADYINN','HABITACION_HOTEL','CRA 20 #26C-45',2,'2 CAMAS CON BA�O',2,120,'1007863897')

INTO INMUEBLE (ID_INMUEBLE, DISPONIBLE,NOMBRE,TIPO_INMUEBLE,UBICACION,CAPACIDAD,DESCRIPCION,VECES_RESERVADA,COSTO_NOCHE,ID_OPERADOR)
VALUES (9, 'Y','APARTAMENTO DE JOSE','APARTAMENTO','CRA 45 #12C-45',6,'3 HABITACIONES 2 BA�OS',5,250,'1007863898')

INTO INMUEBLE (ID_INMUEBLE, DISPONIBLE,NOMBRE,TIPO_INMUEBLE,UBICACION,CAPACIDAD,DESCRIPCION,VECES_RESERVADA,COSTO_NOCHE,ID_OPERADOR)
VALUES (10, 'Y','HABITACION BUEN VIVIR','HABITACION_HOSTEL','CRA 26 #68C-45',2,'2 CAMAS UN BA�O',2,150,'1007863899')
SELECT * FROM dual;
INSERT ALL
...
INSERT ALL
    ...
    VALUES(1234567843,50000)
      ...
      INTO PAGO (ID_PAGO,FECHA_PAGO  , ID_RESERVA )
    VALUES(9,DATE'2015-12-17', 1234567890)
    INTO PAGO (ID_PAGO,FECHA_PAGO  , ID_RESERVA )
    VALUES(10,DATE'2015-12-17', 57239874)
    INTO PAGO (ID_PAGO,FECHA_PAGO  , ID_RESERVA )
    VALUES(11,DATE'2015-12-17', 654846712)
        INTO PAGO (ID_PAGO,FECHA_PAGO  , ID_RESERVA )
    VALUES(12,DATE'2015-12-17', 5678230)
    INTO PAGO (ID_PAGO,FECHA_PAGO  , ID_RESERVA )
    VALUES(13,DATE'2015-12-17', 12758960)
    INTO PAGO (ID_PAGO,FECHA_PAGO  , ID_RESERVA )
    VALUES(14,DATE'2015-12-17', 4327854)
    INTO PAGO (ID_PAGO,FECHA_PAGO  , ID_RESERVA )
    VALUES(15,DATE'2015-12-17', 12782750)
    INTO PAGO (ID_PAGO,FECHA_PAGO  , ID_RESERVA )
    VALUES(16,DATE'2015-12-17', 1582353)
    
    INTO CXC (ID_RESERVA,MONTO)
    VALUES(1234567890,123456643)
        INTO CXC (ID_RESERVA,MONTO)
    VALUES(57239874,123423665)
        INTO CXC (ID_RESERVA,MONTO)
    VALUES(654846712,123458765)
        INTO CXC (ID_RESERVA,MONTO)
    VALUES(5678230,100000)
        INTO CXC (ID_RESERVA,MONTO)
    VALUES(12758960,12345676)
        INTO CXC (ID_RESERVA,MONTO)
    VALUES(4327854,12345601)
        INTO CXC (ID_RESERVA,MONTO)
    VALUES(12782750,21345665)
    INTO CXC (ID_RESERVA,MONTO)
    VALUES(1582353,50000)
SELECT * FROM DUAL;
...
/*RFC5*/
SELECT TIPO_VINCULO_CLIENTE, COUNT (*) FROM(
...
VALUES (11, 'Y','HABITACION BUEN VIVIR','HABITACION_HOSTEL','CRA 26 #68C-45',2,'2 CAMAS UN BA�O',2,150,'1007863899');
/*insersion tupla incorrecta*/
INSERT INTO INMUEBLE (ID_INMUEBLE, DISPONIBLE,NOMBRE,TIPO_INMUEBLE,UBICACION,CAPACIDAD,DESCRIPCION,VECES_RESERVADA,COSTO_NOCHE,ID_OPERADOR)
VALUES (11, 'Y','HABITACION manuela','HABITACION_HOSTEL','CRA 25 #68C-45',2,'2 CAMAS UN BA�O',2,150,'1007863899');
...
INSERT
INTO VIVIENDA_CEDIDA (DIAS_USADO_A�O,SEGURO,ID_INMUEBLE_VC)
...
INSERT INTO INMUEBLE (ID_INMUEBLE, DISPONIBLE,NOMBRE,TIPO_INMUEBLE,UBICACION,CAPACIDAD,DESCRIPCION,VECES_RESERVADA,COSTO_NOCHE,ID_OPERADOR)
VALUES (12, 'TRUE','HABITACION BUEN VIVIR','HABITACION_HOSTEL','CRA 26 #68C-45',2,'2 CAMAS UN BA�O',2,150,'1007863899');
